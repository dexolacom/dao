...
import { JSBI, TokenAmount, ChainId } from 'nimbus-swap-mod/sdk'
      ...
      <TopSection gap="md">
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>Nimbus Governance</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                  UNI tokens represent voting shares in Nimbus governance. You can vote on each proposal yourself or
              ...
              <ExternalLink
                ...
                target="_blank"
              >
                <TYPE.white fontSize={14}>Read more about Nimbus governance</TYPE.white>
              </ExternalLink>
            </AutoColumn>
          </CardSection>
          <CardBGImage />
